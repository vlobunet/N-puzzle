...
// int		key_ho1s(int key, t_visual *tg)
// {
// 	if (key == ESC)
// 		exit(0);
...
// void display_puzzle(t_state *state, t_puzzle *puzzle)
// {
// 	t_visual *tg;

// 	tg = (t_visual *)malloc(sizeof(t_visual));
// 	tg->mlx = mlx_init();
// 	tg->win = mlx_new_window(tg->mlx, W, H, "N-puzzle");


// 	tg->img = mlx_new_image(tg->mlx, W, H);
// 	mlx_ho1(tg->win, 2, 1L << 1, key_ho1s, tg);
// 	mlx_ho1(tg->win, 17, 1L << 17, exit_cl, tg);
// 	mlx_loop(tg->mlx);
// }
// 
